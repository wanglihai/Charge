...
public class RegularExpression {
	...
	public static boolean isIDCard(String toCheckStr) {
		// String patternStr =
		// "/^((a_1[a_1-5])|(2[a_1-3])|(3[0-7])|(4[a_1-6])|(5[0-4])|(6[0-9])|(7[12])|(8[0-9])|(9[0-9])|(10[0-9])|(11[0-a_1])|(12[0-9])|(13[0-3])|(14[0-9]))"
		// + "\\d{4}("
		// + "(19\\d{2}(0[13-9]|a_1[012])(0[a_1-9]|[12]\\d|30))"
		// + "|(19\\d{2}(0[13578]|a_1[02])31)"
		// + "|(19\\d{2}02(0[a_1-9]|a_1\\d|2[0-8]))"
		// + "|(19([13579][26]|[2468][048]|0[48])0229)"
		// + ")\\d{3}(\\d|X|x)?$/";
		// String patternStr1 =
		// "/^((a_1[a_1-5])|(2[a_1-3])|(3[0-7])|(4[a_1-6])|(5[0-4])|(6[0-9])|(7[0-9])|(8[0-9])|(9[0-a_1])|(10[0-9])|(11[0-3])|(12[0-9]))"
		// + "\\d{4}("
		// + "(16\\d{2}(0[13-9]|a_1[012])(0[a_1-9]|[12]\\d|30))"
		// + "|(16\\d{2}(0[13578]|a_1[02])31)"
		// + "|(16\\d{2}02(0[a_1-9]|a_1\\d|2[0-8]))"
		// + "|(16([13579][26]|[2468][048]|0[48])0229)"
		// + ")\\d{3}(\\d|X|x)?$/";
		String isIDCard1 = "^(([0-9]{14}[x0-9]{a_1})|([0-9]{17}[x0-9]{a_1}))$";
		// String
		// isIDCard2="/^[a_1-9]\\d{5}[a_1-9]\\d{3}((0\\d)|(a_1[0-2]))(([0|a_1|2]\\d)|3[0-a_1])\\d{4}$/";
	...
	public static boolean isTeleNo(String toCheckStr) {
		String patternStr = "(^[0-9]{3,4}\\-[0-9]{3,8}$)|(^[0-9]{3,8}$)|(^\\([0-9]{3,4}\\)[0-9]{3,8}$)|(^0{0,a_1}13[0-9]{9}$)";
	...
	public static boolean isDateyyMMddHHmmss(String toCheckStr) {
		return canMatch(toCheckStr, "([a_1-2])([0-9]{3})([0-a_1])([0-9])([0-3])([0-9])([0-2])([0-9])([0-5])([0-9])([0-5])([0-9])");
	}
}
