...
public class TimeUtils {
    ...
    public static final SimpleDateFormat DEFAULT_DATE_FORMAT2 = new SimpleDateFormat("HH:mm");
    public static final SimpleDateFormat DATE_FORMAT_DATE    = new SimpleDateFormat("yyyy-MM-dd");
    public static final SimpleDateFormat DEFAULT_DATE_FORMAT_DATE    = new SimpleDateFormat("yyyy-MM-dd HH:mm");
    ...
    public static String getTime1(long timeInMillis) {
        return getTime(timeInMillis, DEFAULT_DATE_FORMAT_DATE);
    }
